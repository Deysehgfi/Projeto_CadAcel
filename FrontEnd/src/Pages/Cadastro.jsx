...
import { Label,InputFields, InputStyle} from "../styled/Input.js";
import Botao from "../Components/Botao/Botao.jsx";
import { LinkForm, TituloForm, BOxTitulo, Select, SectionCadastro, SelectFields, ImgIcon} from "../styled/Cadastro.js";
import { LabelSelect } from "../styled/Formulario.js";
            ...
            <SectionCadastro>
                <motion.form className="form-design" initial={{ x: 100, opacity: 0 }} animate={{
                    ...
                    <InputFields className="input-fields">
                        ...
                        <LabelSelect> <ImgIcon src={Icondata} alt="" className="imgIConEmail" />data de nascimento</LabelSelect>
                    </InputFields>
                    ...
                    <SelectFields>
                        ...
                        <LabelSelect>Deficiência</LabelSelect>
                    </SelectFields>
