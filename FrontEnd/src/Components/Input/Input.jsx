...
const Input = ({TipoInput, NomeInput, NameLabel, IconImg, tipoDeUseState, Index, FuncaoInput}) => {
    return(
        <InputFields className="input-fields">
        <InputStyle tabIndex={Index} type={TipoInput} name={NomeInput} placeholder=""  required/>
